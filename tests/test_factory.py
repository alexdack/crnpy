...
def test_create_crn_from_dict():
    ...
    crn = crnpy.create_crn(from_dict=dict)
    ...
    test_dict = crn.to_dict()

    np.testing.assert_array_equal(test_dict["species"], species)
    np.testing.assert_array_equal(test_dict["reaction_rates"], reaction_rates)
    np.testing.assert_array_equal(test_dict["reaction_stoichiometry"], react_stoch)
    np.testing.assert_array_equal(test_dict["product_stoichiometry"], prod_stoch)
    np.testing.assert_array_equal(test_dict["initial_concentrations"], inits)
